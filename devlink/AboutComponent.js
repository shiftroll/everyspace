...
import _styles from "./AboutComponent.module.css";
...
export function AboutComponent({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "the-container-about-us")}
      tag="div"
      bind="65654616-305f-01e4-9fb1-9a05bad58b45"
      id="about-content"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "content---about-us", "_1")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "subheading-title")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "heading-title")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "banner", "verdes", "_1")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "image-wrapper-pick")}
            tag="div"
          >
            <_Builtin.Image
              className={_utils.cx(_styles, "image---pick", "verdes")}
              loading="eager"
              height="1000"
              width="1200"
