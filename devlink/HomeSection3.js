...
import _styles from "./HomeSection3.module.css";
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "content-10")} tag="div">
        ...
        <_Builtin.Block className={_utils.cx(_styles, "subheading")} tag="div">
          <_Builtin.Block
            className={_utils.cx(_styles, "text-99")}
            tag="div"
      ...
      <_Builtin.Block className={_utils.cx(_styles, "rent-book")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "rent-book-buttons")}
          tag="div"
        >
          <_Builtin.Link
            className={_utils.cx(_styles, "cta-button", "white", "_50")}
            button={false}
            sym-bind='{"link":{"type":"Select","val":{"from":{"type":"Variable","val":"data"},"prop":"fd0b893f-7cd4-6f18-2e7f-5f5e8261d191"}}}'
            options={ctaButtonLink}
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "cta-eresidence-text-1")}
              tag="div"
          ...
          <_Builtin.Link
            className={_utils.cx(_styles, "cta-button", "blue", "_50")}
            button={false}
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "cta-eresidence-text-1", "rent")}
              tag="div"
