...
export function Column2BottomPage({
  ...
  return (
    ...
    >
      ...
      />
      <_Builtin.Block className=" content-2" tag="div">
        <_Builtin.Block className="subheading-2" tag="div">
          <_Builtin.Block
            className="text-5"
            tag="div"
        ...
        <_Builtin.Block className="content-3" tag="div">
          <_Builtin.Link
            className=" button-9-copy"
            button={false}
            options={{
              href: "#",
            }}
          >
            <_Builtin.Block className=" earn-now" tag="div">
              {"Earn Now"}
            </_Builtin.Block>
          </_Builtin.Link>
        </_Builtin.Block>
