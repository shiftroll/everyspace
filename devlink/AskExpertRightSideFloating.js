...
export function AskExpertRightSideFloating({
  ...
  return (
    <_Component
      className="right-side-floating"
      tag="div"
      bind="dcb10ac4-e8e7-bbd9-23dd-140f05db2261"
    >
      <_Builtin.Block className="ask-expert-info" tag="div">
        <_Builtin.Block className="div-block-120" tag="div">
          <_Builtin.Image
          ...
          />
          <_Builtin.Block className="ask-our-expert-floating" tag="div">
            {"Ask Our Expert"}
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block
        className="ask-expert-floating-button"
