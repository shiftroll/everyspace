...
export function Column1BottomPage({
  ...
  return (
    ...
    >
      ...
      />
      <_Builtin.Block className="content-2-evrspace" tag="div">
        ...
        <_Builtin.Block className="heading-3-evrspace" tag="div">
          <_Builtin.Block
            className="heading-4-evrspace"
            tag="div"
      ...
      <_Builtin.Block className="explore-more" tag="div">
        <_Builtin.Link
          className="button-2"
          button={false}
          options={{
        ...
        >
          <_Builtin.Block className="plan-now" tag="div">
            {"Experience Now"}
          </_Builtin.Block>
        </_Builtin.Link>
      </_Builtin.Block>
